...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton(' AᎠᎠ ME ϮԾ YԾUᏒ GᏒԾUᎮ ', url=f'http://t.me/{temp.U_NAME}?startgroup=true')
            ],[
            InlineKeyboardButton(' SEAᏒCH HEᏒE ', switch_inline_query_current_chat='')
            ],[
            InlineKeyboardButton(' CHAИИEL ', url='https://t.me/fondness_movi'),
            InlineKeyboardButton(' UᎮDATES ', url='https://t.me/source_code_fondness')
            ],[
            InlineKeyboardButton(' LIИK GEИEᏒATOᏒ ', url='http://t.me/Fondness_1_bot')
            ],[
            InlineKeyboardButton(' HELᎮ ', callback_data='help'),
            InlineKeyboardButton(' ABOUT ', callback_data='about')
            ],[
            InlineKeyboardButton(' ᖴᗩCEᗷOOK ', url='https://www.facebook.com/profile.php?id=100087875181009'),
            InlineKeyboardButton(' IИSTAGᏒAM ', url='https://www.instagram.com/kofhb.ae/')
            ],[
            InlineKeyboardButton(' SUBSCᏒIBE  ', url='https://www.youtube.com/shorts/v3TtNplrek4')
        ]]         
        reply_markup = InlineKeyboardMarkup(buttons)        
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('sᴜʙsᴄʀɪʙᴇ', url='https://www.youtube.com/shorts/v3TtNplrek4') ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
