...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton(' SEΛᏒCH HEᏒE ', switch_inline_query_current_chat='')
            ],[
            ...
            InlineKeyboardButton(' LIИK GEИEᏒATOᏒ ', url='https://t.me/FileTo_Link_RoBot')
            ],[
            ...
            InlineKeyboardButton(' SUBSCᏒIBΞ  ', url='https://www.youtube.com/shorts/v3TtNplrek4')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
